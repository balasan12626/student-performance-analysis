...
plt.savefig('images/score_distribution_boxplot.png')
print("Saved images/score_distribution_boxplot.png")
# plt.show()
plt.close()
...
plt.savefig('images/test_prep_vs_performance.png')
print("Saved images/test_prep_vs_performance.png")
# plt.show()
plt.close()
...
plt.savefig('images/performance_levels_countplot.png')
print("Saved images/performance_levels_countplot.png")
# plt.show()
plt.close()
